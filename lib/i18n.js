...
export const COPY = {
  en: {
    ...
    login_title: "Sign in to TrustLabel",
    login_sub: "Enter your email and we'll send you a sign-in link. No password.",
    login_email: "Email",
    login_email_placeholder: "you@example.com",
    login_send: "Send me a link",
    login_sending: "Sending\u2026",
    login_sent_title: "Check your email",
    login_sent_body:
      "We sent a sign-in link to {email}. It can only be used once, and it expires shortly.",
    login_resend: "Send another link",
    login_resend_in: "Send another link in {n}s",
    login_spam: "Nothing after a minute? Check your spam folder before sending again.",
    login_invalid:
      "That doesn't look like an email address — check for a missing @ or a typo in the domain.",
    login_rate: "Too many sign-in emails too quickly. Wait a minute, then try again.",
    login_error: "We couldn't send the link. Check the address and try again.",
    login_link_failed:
      "That sign-in link didn't work. Links expire and can only be used once — send yourself a new one.",

    card_check: "Check",
    check_title: "Is it actually showing?",
    check_url_placeholder: "https://your-shop.example.com/product/1",
    check_run: "Check",
    check_running: "Checking\u2026",
    check_found: "Found. The disclosure is on that page.",
    check_not_found:
      "We loaded that page and could not find the disclosure on it.",
    check_unchecked: "We could not check that page.",
    check_reason_invalid: "That does not look like a URL.",
    check_reason_protocol: "Only http:// and https:// addresses can be checked.",
    check_reason_private:
      "That address is on a private network, so we will not fetch it.",
    check_reason_timeout: "The page took longer than 10 seconds to answer.",
    check_reason_network: "We could not reach that address.",
    check_reason_dns: "That hostname did not resolve.",
    check_reason_redirects: "That address redirected too many times.",
    check_reason_status: "The page answered with HTTP {status}.",
  ...
  ko: {
    ...
    login_title: "TrustLabel 로그인",
    login_sub: "이메일을 입력하면 로그인 링크를 보내드립니다. 비밀번호는 없습니다.",
    login_email: "이메일",
    login_email_placeholder: "you@example.com",
    login_send: "링크 보내기",
    login_sending: "보내는 중\u2026",
    login_sent_title: "메일함을 확인하세요",
    login_sent_body: "{email}로 로그인 링크를 보냈습니다. 한 번만 사용할 수 있고 잠시 후 만료됩니다.",
    login_resend: "링크 다시 보내기",
    login_resend_in: "{n}초 후 다시 보낼 수 있습니다",
    login_spam: "1분이 지나도 오지 않으면 스팸함을 확인한 뒤 다시 보내세요.",
    login_invalid: "이메일 주소 형식이 아닙니다. @가 빠졌거나 도메인에 오타가 없는지 확인해 주세요.",
    login_rate: "로그인 메일을 너무 자주 요청했습니다. 잠시 후 다시 시도해 주세요.",
    login_error: "링크를 보내지 못했습니다. 주소를 확인하고 다시 시도해 주세요.",
    login_link_failed:
      "로그인 링크가 동작하지 않았습니다. 링크는 한 번만 사용할 수 있고 잠시 후 만료됩니다. 새 링크를 받아 주세요.",

    card_check: "확인",
    check_title: "실제로 표시되고 있나요?",
    check_url_placeholder: "https://your-shop.example.com/product/1",
    check_run: "확인하기",
    check_running: "확인 중\u2026",
    check_found: "확인했습니다. 해당 페이지에 정보공개가 표시되고 있습니다.",
    check_not_found: "페이지는 열렸지만 정보공개를 찾지 못했습니다.",
    check_unchecked: "해당 페이지를 확인하지 못했습니다.",
    check_reason_invalid: "URL 형식이 아닙니다.",
    check_reason_protocol: "http:// 또는 https:// 주소만 확인할 수 있습니다.",
    check_reason_private: "사설망 주소여서 접속하지 않습니다.",
    check_reason_timeout: "10초 안에 응답하지 않았습니다.",
    check_reason_network: "해당 주소에 접속하지 못했습니다.",
    check_reason_dns: "호스트 이름을 확인하지 못했습니다.",
    check_reason_redirects: "리디렉션이 너무 많습니다.",
    check_reason_status: "페이지가 HTTP {status}로 응답했습니다.",
